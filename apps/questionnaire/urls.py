...
urlpatterns = [
    ...
    path('survey/<int:questionnaire_id>/single_choose_remove/<int:quiz_id>', views.single_choose_remove, name='questionnaire-single-choose-remove'),
    ...
    path('survey/<int:questionnaire_id>/multi_choose_remove/<int:quiz_id>', views.multi_choose_remove, name='questionnaire-multi-choose-remove'),
    ...
    path('survey/<int:questionnaire_id>/arbitrary_remove/<int:quiz_id>', views.arbitrary_remove_page, name='questionnaire-arbitrary-remove'),
